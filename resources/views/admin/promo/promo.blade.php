            ...
            <div class="col-lg-12">
                <div class="card product_item_list">
                    <div class="body table-responsive">
                        ...
                        tambah_modal_promo('{{csrf_token()}}', '#ModalBiruSm')">Tambah Promo</button>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <tr>
                                        <th scope="row">{{$no}}</th>
                                        {{-- <td>{{$p->id}}</td> --}}
                                        <td>{{$p ->produkatt['SKU']}}</td>
                                        <td>{{$p ->nama_promo}}</td>
                                        <td>{{$p ->jenis_promo}}</td>
                                        <td>@currency($p->nominal_promo)</td>
                                        ...
                                        <span>
                                            ...
                                            update_modal_promo('{{csrf_token()}}', '{{ $p->id }}', '#ModalBiruSm')
                                            " id="modal_update_promo" class="btn btn-default waves-effect waves-float waves-green">
