! function(n) {
 ...
 function Rt(t, e, n, a) {
  ...
  else if (e = (e = qt.ext).sErrMode || e.errMode, t && kt(t, null, "error", [t, a, n]), "alert" == e) /*alert(n);hamdiramadhan*/console.log(n);
  else {
 ...
 var Ut, Vt, Xt, Jt, qt = function(b) {
   ...
   return this.each(function() {
    ...
    if ("table" != this.nodeName.toLowerCase()) Rt(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
     ...
     // null !== t && "" !== t || (this.id = t = "DataTables_Table_" + (Math.floor(Math.random() * (300 + 1) + 1)));
